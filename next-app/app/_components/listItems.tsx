...
export function ListItem({
  ...
  return (
    <div
      onClick={onClick}
      className="cursor-pointer text-wrap text-center relative text-md p-4 rounded shadow visible bg-zinc-100 dark:bg-zinc-600 w-full block mb-2"
    >
      {children}
    </div>
  );
...
export function SecondaryListItem({
  ...
  return (
    <div
      onClick={onClick}
      className="text-wrap cursor-pointer relative text-center text-md rounded shadow p-4 bg-zinc-200 dark:bg-zinc-700 w-full block mb-2"
    >
      {children}
    </div>
  );
